...
def catalog(connection: sqlite3.Connection, payload: dict) -> dict:
    ...
    if entity_type == "club":
        rows = connection.execute(
            ...
            WHERE (? = '' OR lower(team.nome) LIKE lower(?) OR lower(team.arquivo_origem) LIKE lower(?))
