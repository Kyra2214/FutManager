...
s=s.replace(marker,marker+'        if action in {"p1_bolsa_contracts", "p1_bolsa_state", "p1_bolsa_validate", "p1_bolsa_persist", "p1_bolsa_protect", "p1_bolsa_audit"}:\n            return {"ok": True, **p1_bolsa_market(service.connection, action, payload)}\n',1)
...
s=s.replace(choices,choices+'"p1_bolsa_contracts", "p1_bolsa_state", "p1_bolsa_validate", "p1_bolsa_persist", "p1_bolsa_protect", "p1_bolsa_audit", ',1)
p.write_text(s)
