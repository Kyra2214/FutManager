...
s=s.replace(marker,marker+'        if action in {"p1_level_contracts", "p1_level_state", "p1_level_validate", "p1_level_persist", "p1_level_protect", "p1_level_audit"}:\n            return {"ok": True, **p1_level_market(service.connection, action, payload)}\n',1)
...
s=s.replace(choices,choices+'"p1_level_contracts", "p1_level_state", "p1_level_validate", "p1_level_persist", "p1_level_protect", "p1_level_audit", ',1)
p.write_text(s)
