...
s=s.replace(marker,marker+'        if action in {"p1_duel_contracts", "p1_duel_state", "p1_duel_validate", "p1_duel_persist", "p1_duel_protect", "p1_duel_audit"}:\n            return {"ok": True, **p1_duel_market(service.connection, action, payload)}\n',1)
...
s=s.replace(choices,choices+'"p1_duel_contracts", "p1_duel_state", "p1_duel_validate", "p1_duel_persist", "p1_duel_protect", "p1_duel_audit", ',1)
p.write_text(s)
