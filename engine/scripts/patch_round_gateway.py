...
s=s.replace(marker,marker+'        if action in {"p1_round_contracts", "p1_round_state", "p1_round_validate", "p1_round_persist", "p1_round_protect", "p1_round_audit"}:\n            return {"ok": True, **p1_round_market(service.connection, action, payload)}\n',1)
...
s=s.replace(choices,choices+'"p1_round_contracts", "p1_round_state", "p1_round_validate", "p1_round_persist", "p1_round_protect", "p1_round_audit", ',1)
p.write_text(s)
