...
s=s.replace(marker,marker+'        if action in {"p1_draw_contracts", "p1_draw_state", "p1_draw_validate", "p1_draw_persist", "p1_draw_protect", "p1_draw_audit"}:\n            return {"ok": True, **p1_draw_market(service.connection, action, payload)}\n',1)
...
s=s.replace(choices,choices+'"p1_draw_contracts", "p1_draw_state", "p1_draw_validate", "p1_draw_persist", "p1_draw_protect", "p1_draw_audit", ',1)
p.write_text(s)
