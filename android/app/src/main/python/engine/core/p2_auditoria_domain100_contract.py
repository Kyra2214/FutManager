...
# Aliases do domínio 100 sobre a implementação canônica SQL/GameState.
ensure_p2_auditoria_domain100_registry = ensure_p2_auditoria_registry
validate_p2_auditoria_domain100 = validate_p1_auditoria
read_p2_auditoria_domain100s = read_p1_auditorias
protect_p2_auditoria_domain100_mutation = protect_p1_auditoria_mutation
audit_p2_auditoria_domain100s = audit_p2_auditorias
