...
# Aliases do domínio 130 sobre a implementação canônica SQL/GameState.
ensure_p2_auditoria_domain130_registry = ensure_p2_auditoria_registry
validate_p2_auditoria_domain130 = validate_p1_auditoria
read_p2_auditoria_domain130s = read_p1_auditorias
protect_p2_auditoria_domain130_mutation = protect_p1_auditoria_mutation
audit_p2_auditoria_domain130s = audit_p2_auditorias
