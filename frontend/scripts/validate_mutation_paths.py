...
CLIENT = ROOT / 'frontend' / 'client' / 'src'
GATEWAY = ROOT / 'frontend' / 'server' / 'careerGateway.ts'
ENGINE_ROOT = Path(os.environ.get('FUTMANAGER_ENGINE_ROOT', ROOT / 'engine'))
...
engine_gateway = ENGINE_ROOT / 'scripts' / 'career_gateway.py'
...
for service_path in [
    ENGINE_ROOT / 'engine/stadiums/service.py',
    ENGINE_ROOT / 'engine/social/attendance.py',
    ENGINE_ROOT / 'engine/economy/staff_market.py',
    ENGINE_ROOT / 'engine/economy/sponsorships.py',
    ENGINE_ROOT / 'engine/world/weekly_cycle.py',
    ENGINE_ROOT / 'engine/events/service.py',
]:
