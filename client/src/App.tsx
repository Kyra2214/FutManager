...
export type AppSection = "clube" | "partidas" | "estadio" | "time" | "ct" | "mercado" | "patrocinadores" | "transferencias";

function App() {
  const [section, setSection] = useState<AppSection>(() => {
    const requested = new URLSearchParams(window.location.search).get("section");
    const allowed: AppSection[] = ["clube", "partidas", "estadio", "time", "ct", "mercado", "patrocinadores", "transferencias"];
