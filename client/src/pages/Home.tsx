...
export function StructurePage({ section, onSectionChange }: { section: AppSection; onSectionChange: (section: AppSection) => void }) {
  ...
  const structureRows = isFinance
    ? [{ label: "Caixa atual", value: workspace?.finance.cash !== null && workspace?.finance.cash !== undefined ? formatCash(workspace.finance.cash) : "sem registro" }, { label: "Caixa projetado · 39 sem.", value: workspace?.finance.projectedCash39Weeks !== null && workspace?.finance.projectedCash39Weeks !== undefined ? formatCash(workspace.finance.projectedCash39Weeks) : "sem registro" }, { label: "Orçamento", value: workspace?.finance.budget !== null && workspace?.finance.budget !== undefined ? formatCash(workspace.finance.budget) : "sem registro" }, { label: "Folha atletas", value: workspace?.finance.weeklyPlayerPayroll !== null && workspace?.finance.weeklyPlayerPayroll !== undefined ? formatCash(workspace.finance.weeklyPlayerPayroll) : "sem registro" }, { label: "Folha comissão", value: workspace?.finance.weeklyStaffPayroll !== null && workspace?.finance.weeklyStaffPayroll !== undefined ? formatCash(workspace.finance.weeklyStaffPayroll) : "sem registro" }, { label: "Manutenção CT", value: workspace?.finance.weeklyDepartmentMaintenance !== null && workspace?.finance.weeklyDepartmentMaintenance !== undefined ? formatCash(workspace.finance.weeklyDepartmentMaintenance) : "sem registro" }, { label: "Receitas ledger", value: workspace?.finance.ledgerIncome !== null && workspace?.finance.ledgerIncome !== undefined ? formatCash(workspace.finance.ledgerIncome) : "sem registro" }, { label: "Despesas ledger", value: workspace?.finance.ledgerExpense !== null && workspace?.finance.ledgerExpense !== undefined ? formatCash(workspace.finance.ledgerExpense) : "sem registro" }, { label: "Fonte", value: workspace?.finance.source ?? "UNAVAILABLE" }]
    : isStadium
